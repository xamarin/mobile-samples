...
namespace SQLite.iOS.Sample
{
	public partial class TaskListsViewController : DialogViewController
	{
			...
			: base (UITableViewStyle.Plain, null, true)
		{
			...
			var addButton = new UIBarButtonItem (UIBarButtonSystemItem.Add, OnCreateList);
			var refreshButton = new UIBarButtonItem (UIBarButtonSystemItem.Refresh, delegate { RefreshAsync(); });
