...
namespace CreditCardValidation.Tests
{
    ...
    public class iOSQueries : IScreenQueries
    {
        ...
        public Func<AppQuery, AppQuery> SuccessMessageView { get { return c => c.Class("UILabel").Text("The credit card number is valid!"); } }

        public Func<AppQuery, AppQuery> ShortCreditCardNumberView { get { return c => c.Class("UILabel").Text("Credit card number is to short."); } }

        public Func<AppQuery, AppQuery> LongCreditCardNumberView { get { return c => c.Class("UILabel").Text("Credit card number is to long."); } }
