...
namespace MWC.SAL
{
	...
	/// </summary>
	public class RSSParser<RSSEntry> : XmlFeedParserBase<MWC.SAL.RSSEntry>
	{	
		...
		protected override List<MWC.SAL.RSSEntry> ParseXml (string xml)
		{
