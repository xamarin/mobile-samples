...
namespace FruityFalls
{
    public static class GameCoefficients
    {
        ...
        public const float BinHeight = 10;

        // The height of the splitter inbetween the bins
        public const float SplitterHeight = 120;
        ...
        public const float FruitGravity = -120;
        ...
        public const float FruitDrag = .2f;
        ...
        public const float FruitRadius = 32;
